...
function addModel(file, Seq, sequelize) {
    ...
    var model = require(settings.models.modelsPath + '/' + file).model(Seq);
    ...
    Models[modelname] = model = sequelize.define(modelname, model.columns, model.options);
}

module.exports = {
    create: function (Seq, sequelize) {
        utils.forEachDir(settings.models.rootPath + settings.models.modelsPath, true, function (file, filePath) {
